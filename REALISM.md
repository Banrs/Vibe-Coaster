...
| **Sustained felt g** | ~1–2x the element's real sustained value (measured via `--gaudit` SUSTAINED table: TURN 6.1 ≈ 2x, HELIX 8.1 ≈ 1.8x, LOOP 6.7 ≈ 1.5x, IMMEL 4.3 ≈ 1.0x, DIVELOOP 4.0 ≈ 0.95x). |
...
| Drop (tallest) | Falcon's Flight: 158 m drop element, ~195-200 m cliff-assisted elevation change (Six Flags Qiddiya) | mega climbTop frnd(160, 198) = 1.0-1.25x the element; terrain assist takes total crest-to-valley drops to ~180-270 m |
