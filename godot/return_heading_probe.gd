...
const CORE_DURATIONS_S := [1.85, 1.90, 1.95, 2.00, 2.10, 2.20]
const REFINED_SEED := [
	1.23587006291952, 2.27539467676255, 1.08077170973702, 1.12048969438195,
	5.69250008001027, 0.86498699696579, 5.2120475582206, 3.87491961050296,
]
