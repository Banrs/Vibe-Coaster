...
// (submergedGround rehomed to game_state.cpp at migration step 6.)
...
// (rideElemName rehomed to presentation.cpp at migration step 6 — host banner
// diagnosis, unchanged; survives the V1 generator's step-7 deletion.)
